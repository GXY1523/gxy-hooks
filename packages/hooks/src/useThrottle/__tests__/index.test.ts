...
import { sleep } from 'gxyHooks/lib/utils/testingHelpers';
...
describe('useThrottle', () => {
  ...
  it('leading:false & trailing:false of option', async () => {
    let mountedState = 0;
    act(() => {
      hook = renderHook(() =>
  ...
  it('leading:true & trailing:false of option', async () => {
    let mountedState = 0;
    act(() => {
      hook = renderHook(() =>
  ...
  it('leading:false & trailing:true of option', async () => {
    let mountedState = 0;
    act(() => {
      hook = renderHook(() =>
